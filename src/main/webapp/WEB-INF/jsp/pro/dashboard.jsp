                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-lg-4">
                            <div class="panel-card">
                                <form method="get" action="${pageContext.request.contextPath}/pro/dashboard"
                                    class="vstack gap-2">
                                        ...
                                        <tbody>
                                            <c:forEach var="r" items="${replenishmentRows}">
                                                <tr>
                                                    <td>${r.productName}</td>
                                                    <td>
                                                        <fmt:formatNumber value="${r.avg7Days}" type="number"
                                                            minFractionDigits="0" maxFractionDigits="2" />
                                                    </td>
                                                    <td>
                                                        <fmt:formatNumber value="${r.avgHistory}" type="number"
                                                            minFractionDigits="0" maxFractionDigits="2" />
                                                    </td>
                                                    <td>
                                        ...
                                        <table class="table table-sm table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="b" items="${forecastBuckets}">
                                                    <tr
                                                        class="${b.forecast != null && b.actual == null ? 'table-info' : ''}">
                                                        <td>
                                                            <c:out value="${b.label}" />
                                                        </td>
                                                        <td class="text-end">
                            ...
                            <div class="panel-card">
                                <form method="get" action="${pageContext.request.contextPath}/pro/dashboard"
                                    ...
                                    <select class="form-select" name="granularity">
                                        <option value="day" <c:if test="${granularity == 'day'}">selected</c:if>>Day
                                        </option>
                                        <option value="month" <c:if test="${granularity == 'month'}">selected</c:if>
                                            >Month</option>
                                        <option value="quarter" <c:if test="${granularity == 'quarter'}">selected</c:if>
                                            >Quarter</option>
                                        <option value="year" <c:if test="${granularity == 'year'}">selected</c:if>>Year
                                        </option>
                                    </select>

                                    <label class="form-label mb-0">Method</label>
                                    <select class="form-select" name="method">
                                        <option value="ma" <c:if test="${method == 'ma'}">selected</c:if>>Moving Average
                                        </option>
                                        <option value="es" <c:if test="${method == 'es'}">selected</c:if>>Exponential
                                            Smoothing</option>
                                    </select>
