...
<style>
    .pro-tabs { display: flex; gap: 10px; margin-bottom: 20px; flex-wrap: wrap; }
    .pro-tab {
...
<c:choose>
            ...
            <div class="col-lg-4">
                <div class="panel-card">
                    <form method="get" action="${pageContext.request.contextPath}/pro/dashboard" class="vstack gap-2">
                        ...
                        <input class="form-control" type="number" name="seasonalityHistory" value="${seasonalityHistory}" min="30" max="730"/>

                        <label class="form-label mb-0">Rolling window</label>
                        <input class="form-control" type="number" name="rollingWindow" value="${rollingWindow}" min="3" max="30"/>

                        <label class="form-label mb-0">Z-threshold</label>
                        <input class="form-control" type="number" step="0.1" name="zThreshold" value="${zThreshold}" min="0.5" max="5"/>
            ...
            <div class="table-wrap">
                <table class="table table-striped">
                    ...
                    <c:forEach var="m" items="${monthStats}">
                        <tr>
                            <td>${m.label}</td>
                            <td><fmt:formatNumber value="${m.avgDemand}" type="number" minFractionDigits="0" maxFractionDigits="2"/></td>
                            <td><fmt:formatNumber value="${m.minDemand}" type="number" minFractionDigits="0" maxFractionDigits="2"/></td>
                            <td><fmt:formatNumber value="${m.maxDemand}" type="number" minFractionDigits="0" maxFractionDigits="2"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
            ...
            <div class="col-lg-4">
                <div class="panel-card">
                    <form method="get" action="${pageContext.request.contextPath}/pro/dashboard" class="vstack gap-2">
                        ...
                        <label class="form-label mb-0">History (days)</label>
                        <input class="form-control" type="number" name="replenishmentHistory" value="${replenishmentHistory}" min="7" max="90"/>

                        <label class="form-label mb-0">Lead time days</label>
                        <input class="form-control" type="number" name="leadTimeDays" value="${leadTimeDays}" min="1" max="30"/>

                        <label class="form-label mb-0">Buffer days</label>
                        <input class="form-control" type="number" name="bufferDays" value="${bufferDays}" min="0" max="30"/>

                        <label class="form-label mb-0">Safety days</label>
                        <input class="form-control" type="number" name="safetyDays" value="${safetyDays}" min="0" max="30"/>
                    ...
                    <div class="table-wrap">
                        <table class="table table-striped">
                            ...
                            <c:forEach var="r" items="${replenishmentRows}">
                                <tr>
                                    <td>${r.productName}</td>
                                    <td><fmt:formatNumber value="${r.avg7Days}" type="number" minFractionDigits="0" maxFractionDigits="2"/></td>
                                    <td><fmt:formatNumber value="${r.avgHistory}" type="number" minFractionDigits="0" maxFractionDigits="2"/></td>
                                    <td><fmt:formatNumber value="${r.seasonFactor}" type="number" minFractionDigits="0" maxFractionDigits="2"/></td>
                                    <td><fmt:formatNumber value="${r.forecastPerDay}" type="number" minFractionDigits="0" maxFractionDigits="2"/></td>
                                    <td>${r.stock}</td>
    ...
    <c:otherwise>
        <div class="kpi-grid">
            ...
            <div class="kpi-card">
                <h6>Latest Actual</h6>
                <div class="value"><fmt:formatNumber value="${latestActual}" type="number" minFractionDigits="0" maxFractionDigits="2"/></div>
            </div>
            <div class="kpi-card">
                <h6>Latest Forecast</h6>
                <div class="value"><fmt:formatNumber value="${latestForecast}" type="number" minFractionDigits="0" maxFractionDigits="2"/></div>
            </div>
        </div>
