...
<div class="container-fluid px-4 py-4">
    ...
    <ul class="nav fm-nav-pills gap-2 mb-5">
        <li class="nav-item">
            <a class="nav-link ${tab == 'forecast' or empty tab ? 'active' : ''}"
        ...
        <li class="nav-item">
            <a class="nav-link ${tab == 'seasonality' ? 'active' : ''}"
        ...
        <li class="nav-item">
            <a class="nav-link ${tab == 'replenishment' ? 'active' : ''}"
    ...
    <c:choose>
        <c:when test="${tab == 'forecast' or empty tab}">
            <div class="row g-4 mb-5">
                <div class="col-md-3">
                    <div class="fm-pro-card p-4 h-100">
                        <div class="d-flex justify-content-between mb-3">
                            <div class="fm-kpi-pro-icon bg-primary-subtle text-primary">
                ...
                <div class="col-md-3">
                    <div class="fm-pro-card p-4 h-100">
                        <div class="d-flex justify-content-between mb-3">
                            <div class="fm-kpi-pro-icon bg-success-subtle text-success">
                        ...
                        <div class="fm-h2 mb-0">
                            <fmt:formatNumber value="${latestActual}" type="number" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="fm-pro-card p-4 h-100">
                        <div class="d-flex justify-content-between mb-3">
                            <div class="fm-kpi-pro-icon bg-indigo-subtle text-indigo-600">
                        ...
                        <div class="fm-h2 mb-0">
                            <fmt:formatNumber value="${latestForecast}" type="number" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="fm-pro-card p-4 h-100">
                        <div class="d-flex justify-content-between mb-3">
                            <div class="fm-kpi-pro-icon bg-amber-subtle text-amber-600">
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="fm-surface p-4 shadow-sm border-0 mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a class="fm-btn btn-light border btn-sm"
                ...
                <div class="col-lg-4">
                    <div class="fm-surface p-4 shadow-sm border-0 sticky-top" style="top: 1rem;">
                        <h5 class="fm-h3 mb-4 text-dark">
                            <i class="bi bi-sliders me-2 text-primary"></i> Algorithm Parametrics
                        </h5>
                        ...
                        <form method="get" class="vstack gap-4">
                            ...
                            <div>
                                ...
                                <select class="fm-form-control" name="granularity">
                                    ...
                                    <option value="year" ${granularity == 'year' ? 'selected' : ''}>Year</option>
                                </select>
                            </div>
                            ...
                            <c:choose>
                                <c:when test="${method == 'es'}">
                                    <div>
                                        <label class="fm-caption fw-bold text-muted d-block mb-2">Alpha (0..1)</label>
                                        <input class="fm-form-control" type="number" step="0.05" name="alpha"
                                               value="${alpha}" min="0.05" max="0.95" />
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <div>
                                        <label class="fm-caption fw-bold text-muted d-block mb-2">Window</label>
                                        <input class="fm-form-control" type="number" name="window" value="${window}" min="3" max="30" />
                                    </div>
                                </c:otherwise>
                            </c:choose>

                            <button class="fm-btn fm-btn-primary w-100 py-3 fw-bold" type="submit">
                        ...
                        <div class="p-3 bg-light rounded-4 mt-5 border-0">
                            ...
                            <p class="small text-muted mb-0">
                                Source: <code>revenue_daily</code> aggregated by COMPLETED fulfillments.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <c:when test="${tab == 'seasonality'}">
            <div class="row g-4 mb-5">
                <div class="col-md-3">
                    <div class="fm-pro-card p-4 h-100">
                        <div class="fm-kpi-pro-icon bg-info-subtle text-info mb-3">
                            <i class="bi bi-clock-history"></i>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="fm-pro-card p-4 h-100">
                        <div class="fm-kpi-pro-icon bg-success-subtle text-success mb-3">
                ...
                <div class="col-md-3">
                    <div class="fm-pro-card p-4 h-100">
                        <div class="fm-kpi-pro-icon bg-danger-subtle text-danger mb-3">
                ...
                <div class="col-md-3">
                    <div class="fm-pro-card p-4 h-100">
                        <div class="fm-kpi-pro-icon bg-indigo-subtle text-indigo-600 mb-3">
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="fm-surface p-4 shadow-sm border-0 sticky-top" style="top: 1rem;">
                        <h5 class="fm-h3 mb-4 text-dark">
                            <i class="bi bi-funnel me-2 text-primary"></i> Analytical Constraints
                        </h5>
                        ...
                        <form method="get" class="vstack gap-4">
                            ...
                            <div>
                                ...
                                <input class="fm-form-control" type="number" name="seasonalityHistory"
                                       value="${seasonalityHistory}" min="7" max="730" />
                            </div>

                            <div>
                                <label class="fm-caption fw-bold text-muted d-block mb-2">Rolling Mean Window</label>
                                <input class="fm-form-control" type="number" name="rollingWindow"
                                       value="${rollingWindow}" min="3" max="30" />
                            </div>

                            <div>
                                <label class="fm-caption fw-bold text-muted d-block mb-2">Anomaly Z-Threshold</label>
                                <input class="fm-form-control" type="number" step="0.1" name="zThreshold"
                                       value="${zThreshold}" min="0.5" max="5" />
                            </div>

                            <button class="fm-btn fm-btn-primary w-100 py-3 fw-bold" type="submit">
                                Run Seasonality Sync
                            </button>
                        </form>

                        <div class="insight bg-light p-3 rounded-4 mt-5">
                            <p class="small text-muted mb-0">
                                <strong>Peak Detection:</strong> Revenue > rolling mean + offset.<br />
                                <strong>Dip Detection:</strong> Revenue < rolling mean - offset.
                            </p>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    if (activeTab === 'forecast' || activeTab === '') {
    ...
    if (activeTab === 'seasonality') {
        ...
        const seasonalityCanvas = document.getElementById('seasonalityChart');
        if (seasonalityCanvas) {
            new Chart(seasonalityCanvas, {
                ...
                data: {
                    labels,
                    datasets: [
                        { label: 'Actual Revenue', data: actual, borderColor: '#2563eb', tension: 0.4, spanGaps: true },
                        { label: 'Rolling Mean', data: rolling, borderColor: '#64748b', borderDash: [5, 5], tension: 0.4, spanGaps: true }
                    ]
                },
                options: {
                    responsive: true,
