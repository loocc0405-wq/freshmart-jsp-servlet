                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                        <fmt:formatNumber value="${fillPercent}" maxFractionDigits="0" var="fmtFillPercent"/>
                                        <div class="progress me-1" style="width: 50px; height: 4px;">
                                            <div class="progress-bar bg-info" <c:out value="style='width: ${fmtFillPercent}%'" escapeXml="false" />></div>
                                        </div>
