        ...
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
                ...
                <div>
                    <c:choose>
                        <c:when
                            test="${sessionScope.authUser != null && sessionScope.authUser.tier.toString() eq 'PRO' && sessionScope.authUser.proActive}">
                        ...
                        <c:when
                            test="${sessionScope.authUser != null && sessionScope.authUser.tier.toString() eq 'PRO'}">
                                            ...
                                            <c:when test="${sessionScope.authUser.proActive}">
                                                <span class="text-success fw-semibold">
                                                    ...
                                                    <c:if test="${sessionScope.authUser.remainingProDays >= 0}">
                                                        (
                                                        <c:out value="${sessionScope.authUser.remainingProDays}" /> ngày
                                                        còn lại)
                                                    </c:if>
                                                </span>
                                            </c:when>
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${h.changeType eq 'ADMIN_GRANT'}">
                                                                <span class="badge text-bg-warning">ADMIN GRANT</span>
                                                            </c:when>
